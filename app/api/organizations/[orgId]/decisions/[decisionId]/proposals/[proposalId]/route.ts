...
// PATCH /api/organizations/[orgId]/decisions/[decisionId]/proposals/[proposalId] - Met à jour une proposition
export async function PATCH(
  request: NextRequest,
  { params }: { params: { orgId: string; decisionId: string; proposalId: string } }
) {
  try {
    ...
    const { orgId, decisionId, proposalId } = params;
...
// DELETE /api/organizations/[orgId]/decisions/[decisionId]/proposals/[proposalId] - Supprime une proposition
